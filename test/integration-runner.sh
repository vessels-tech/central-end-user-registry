...
psql <<'EOSQL'
    DROP DATABASE IF EXISTS "central_end_user_registry_integration";
	  CREATE DATABASE "central_end_user_registry_integration";
EOSQL

export CREG_DATABASE_URI="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:15432/central_end_user_registry_integration"
